...
if %ERRORLEVEL% equ 0 (
    echo Git verification successful. >> %LOGFILE%
    echo Git installed and verified successfully.
) else (
    echo Git verification failed. Git may not have installed correctly. See log for details. >> %LOGFILE%
    echo Git verification failed. See log for details.
)

echo ===========================================
echo Git installation process completed.
